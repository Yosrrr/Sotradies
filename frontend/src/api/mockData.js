...
export const MOCK_DASHBOARD = {
  ...
  alertes_du_jour: [
    ...
    { id: "t-2", objet: "Chariots élévateurs — Office des Ports Nationaux", score: 88, commercial: "Ramzi Trabelsi" },
  ],
  repartition_commerciaux: [
    { commercial: "Ramzi Trabelsi", marque: "IVECO", nb_marches: 3 },
    { commercial: "Ramzi Trabelsi", marque: "CASE", nb_marches: 1 },
    { commercial: "Ramzi Trabelsi", marque: "CG Est Manutention", nb_marches: 2 },
  ],
  dernier_scraping: {
